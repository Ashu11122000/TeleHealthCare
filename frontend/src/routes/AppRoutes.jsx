...
import Availability from "../doctor/pages/Availability";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<FeatureRoleGuard allowedRoles={["patient"]} />}>
        ...
        {/* ================= DOCTOR ROUTES ================= */}
        <Route element={<ProtectedRoute />}>
          <Route element={<FeatureRoleGuard allowedRoles={["doctor"]} />}>
        ...
        {/* ================= ADMIN ROUTES ================= */}
        <Route element={<ProtectedRoute />}>
          <Route element={<FeatureRoleGuard allowedRoles={["admin"]} />}>
